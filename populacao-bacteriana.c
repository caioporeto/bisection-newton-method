...
double funcao(double x){
    ...
    return exp(0.5*x)-5; //write your function here
}

double derivada_funcao(double x){
 
    return exp(0.5*x)*0.5; //write your derived fuction here
}
...
int main(){
    ...
    min = 100;
    int i=1;
    double RTOL = 0.0000000001; // RTOL is the tolerance chose for the root(s)
